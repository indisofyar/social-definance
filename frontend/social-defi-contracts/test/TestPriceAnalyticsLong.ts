...
import { FlareContractRegistryMockInstance, PriceAnalyticsLongContract, PriceAnalyticsLongInstance } from '../typechain-types';
...
describe('PriceAnalytics', async () => {
    ...
    let priceAnalytics: PriceAnalyticsLongInstance
